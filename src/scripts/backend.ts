...
const softwareDevelopment = { 
    ...
    description: "I can develop most software, and if i can't then i can learn how to.\n"+
...
const pcBuilding = { 
    title: "PC Building", 
    description: "I can build somewhat basic pc's for now, but am open to learn building custom watercooling, at a reduced rate ofcourse.\n"+
...
const keyboardBuilding = { 
    ...
    description: "I offer building keyboards, where i can help you source the parts if you don't wanna do it yourself.\n"+
...
export const GetServices = (): Service[] => [softwareDevelopment, pcBuilding, keyboardBuilding];